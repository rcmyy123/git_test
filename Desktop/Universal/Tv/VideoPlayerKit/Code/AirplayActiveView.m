...
- (void)layoutSubviews
{
    ...
    CGSize titleLabelSize = [[_titleLabel text] sizeWithAttributes: @{NSFontAttributeName:
                                   [_titleLabel font]}];

    CGSize descriptionLabelSize = [[_descriptionLabel text] sizeWithAttributes: @{NSFontAttributeName:
